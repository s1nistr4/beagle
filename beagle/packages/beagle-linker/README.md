...
## Installation
    ...
    npm install beagle-linker

## Usage

```js
var link = require('beagle-linker');
```
...
This function merely links the AST together; it doesn't read the file system to resolve and parse included and extended files. Thus, the main AST must already have the ASTs of the included and extended files embedded in the `FileReference` nodes. `beagle-load` is designed to do that.
