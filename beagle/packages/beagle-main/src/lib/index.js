...
exports.compileClientWithDependenciesTracked = function(str, options) {
  ...
  if (options.module) {
    if (options.inlineRuntimeFunctions === false) {
      body = 'var pug = require("beagle-runtime");' + body;
    }
